...
class HomeViewController: UIViewController {
    ...
    var options: [option] = [option(image: UIImage(systemName: "person.fill")!,title: "Profile", segue: "Profile"),option(image: UIImage(systemName: "house.fill")!,title: "Home", segue: "Home"),option(image: UIImage(systemName: "list.bullet")!,title: "List", segue: "Home"),option(image: UIImage(systemName: "return.right")!,title: "Logout", segue: "Logout")]
...
extension HomeViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, PostViewControllerDelegate{
